...
| [12. Integer to Roman](https://leetcode-cn.com/problems/integer-to-roman/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc12_integer_to_roman.py) | Medium | decode mapping with greedy thinking |
| [13. Roman to Integer](https://leetcode-cn.com/problems/roman-to-integer/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc13_roman_to_integer.py) | Easy | string traversal |
...
| [138. Copy List with Random Pointer](https://leetcode-cn.com/problems/copy-list-with-random-pointer/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc138_copy_list_with_random_pointer.py) | Medium | 1.backtracing<br>2.continuous copied node in space |
...
| [168. Excel Sheet Column Title](https://leetcode-cn.com/problems/excel-sheet-column-title/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc168_Excel_sheet_column_title.py) | Easy | DFS<br>iteration |
| [171. Excel Sheet Column Number](https://leetcode-cn.com/problems/excel-sheet-column-number/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc171_Excel_sheet_column_number.py) | Easy | iteration 26-binary form |
...
| [218. The Skyline Problem](https://leetcode-cn.com/problems/the-skyline-problem/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc218_[Hard]_the_skyline_problem.py) | Hard | scan + priority-queue |
...
| [231. Power of Two](https://leetcode-cn.com/problems/power-of-two/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc231_Power_of_tow.py) | Easy | bitwise, n as divisor |
...
| [342. Power of Four](https://leetcode-cn.com/problems/power-of-four/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc342_power_of_four.py) | Easy | 1. sqrt+powerOf2<br>2. Bitwise |
...
| [345. Reverse Vowels of a String](https://leetcode-cn.com/problems/reverse-vowels-of-a-string/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc377[DP]_Combination_Sum_IV.py) | Medium | 1. recursive with cache<br>2. DP |
...
| [421. Maximum XOR of Two Numbers in an Array](https://leetcode-cn.com/problems/maximum-xor-of-two-numbers-in-an-array/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc421_Maximum_XOR_of_two_numbers_in_an_array.py) | Medium | bitwise |
...
| [451. Sort Characters By Frequency](https://leetcode-cn.com/problems/sort-characters-by-frequency/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc451_Sort_characters_by_frequency.py) | Medium | ordered dict |
| [461. Hamming Distance](https://leetcode-cn.com/problems/hamming-distance/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc461_Hamming_distance.py) | Easy | XOR+NumberOf1 |
| [477. Total Hamming Distance](https://leetcode-cn.com/problems/total-hamming-distance/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc477_Total_hamming_distance.py) | Medium | Bitwise |
...
| [581. Shortest Unsorted Continuous Subarray](https://leetcode-cn.com/problems/shortest-unsorted-continuous-subarray/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc581_Shortest_unsorted_continuous_subarray.py) | Medium | 1. sort and compare <br>2. find the law |
...
| [645. Set Mismatch](https://leetcode-cn.com/problems/set-mismatch/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc645_Set_mismatch.py) | Easy | count-array |
...
| [692. Top K Frequent Words](https://leetcode-cn.com/problems/top-k-frequent-words/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc692_topK_frequent_words.py) | Medium | 1. hashtable+sort <br>2. priority queue |
...
| [726. Number of Atoms](https://leetcode-cn.com/problems/number-of-atoms/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc726_[Hard]_Number_of_atoms.py) | Hard | stack with hashtable |
...
| [1035. Uncrossed Lines](https://leetcode-cn.com/problems/uncrossed-lines/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1035[DP]_uncrossed_lines.py) | Medium | 2D-DP |
...
| [1190. Reverse Substrings Between Each Pair of Parentheses](https://leetcode-cn.com/problems/reverse-substrings-between-each-pair-of-parentheses/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1190_Reverse_substrings_between_each_pair_of_parentheses.py) | Medium | 1. stack/recursive |
| [1310. XOR Queries of a Subarray](https://leetcode-cn.com/problems/xor-queries-of-a-subarray/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1310_XOR_queries_of_a_subarray.py) | Medium | XOR, prefix sum |
| [1337. The K Weakest Rows in a Matrix](https://leetcode-cn.com/problems/the-k-weakest-rows-in-a-matrix/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1337_the_K_weakest_rows_in_a_matrix.py) | Easy | Dichotomy+Mini-Heap |
| [1418. Display Table of Food Orders in a Restaurant](https://leetcode-cn.com/problems/display-table-of-food-orders-in-a-restaurant/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1418_Display_table_of_food_orders_in_a_restaurant.py) | Medium | Hashtable |
...
| [1442. Count Triplets That Can Form Two Arrays of Equal XOR](https://leetcode-cn.com/problems/count-triplets-that-can-form-two-arrays-of-equal-xor/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1442_Count_triplets_that_can_form_two_arrays_of_equal_XOR.py) | Medium | XOR, prefix sum, mapping |
...
| [1711. Count Good Meals](https://leetcode-cn.com/problems/count-good-meals/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1711_Count_good_meals.py) | Medium | hashtable, traverse targets |
...
| [1736. Latest Time by Replacing Hidden Digits](https://leetcode-cn.com/problems/latest-time-by-replacing-hidden-digits/) | [Python](https://github.com/Fieldwater/leetcode/blob/master/python/lc1736_Latest_time_by_replacing_hidden_digits.py) | Easy | Greedy, bitwise judgement |
